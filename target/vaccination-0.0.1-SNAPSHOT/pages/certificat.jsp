            ...
            <div class="row">
               <div class="col-lg-4 ml-auto mr-auto">
                  <div class="card card-register">
                     ...
                     <form action="PDFCertificat" class="register-form" method="POST">
                        <label>CIN</label>
                        <input type="text" class="form-control" placeholder="CIN" name="txtCIN">
                        <label>Password</label>
                        <input type="password" class="form-control" placeholder="Password" name="txtPassword">
                        <button class="btn btn-danger btn-block btn-round">Telecharger</button>
                     </form>
                     <div class="errorMessage">${errorMessage}</div>
                     <div class="forgot" style="color:green">
